...
public class DetailActivity extends AppCompatActivity {
    ...
    EditText editText2,editText4,editText5,editText6,editText7,editText8,editText9;
    ImageView imageView3;
    String name,address_line1,address_line2,city,state,pin_code,name1,email;
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(name1.isEmpty()){
                    ...
                    startActivity(new Intent(DetailActivity.this,Userlogin.class));
                }
            }
            @Override
    ...
    public boolean validate(){
        ...
        if (name.isEmpty() || email.isEmpty() || address_line1.isEmpty() || address_line2.isEmpty() || city.isEmpty() || state.isEmpty() || pin_code.isEmpty()){
    ...
    private void sendUserData(){
        ...
        UserProfile userProfile = new UserProfile(name,email, address_line1, address_line2, city, state, pin_code);
